...

{
    ...
    public void TakeDamage(float damage)
    {
        ...
        // If the health is equal to or less than zero then the following gets implemented:
        {
            ...
            // This line disables the renderer when the health of "fighter1" reaches zero. I implemented this because you could still see the ship after the explosion sequence was completed. As soon as the health reaches zero the renderer component for this GameObject is disabled which makes the ship disappear immediately.
